...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#savaCreateActivityRemarkBtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == 1) {
                            ...
                            htmlStr += "<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small id=\"small_"+data.retData.id +"\" style=\"color: gray;\"> " + data.retData.createTime + " 由${sessionScope.sessionUser.name}创建</small>";
...
<!-- 备注 -->
<div style="position: relative; top: 30px; left: 40px;" id="RemarksList">
    <div class="page-header">
        <h4>备注</h4>
    </div>
    <c:forEach items="${activitiesRemarks}" var="remark">
    ...
    <div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
        <form role="form" style="position: relative;top: 10px; left: 10px;">
            ...
            <p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
                ...
                <button type="button" class="btn btn-primary" id="savaCreateActivityRemarkBtn">保存</button>
            </p>
        </form>
    </div>
</div>
